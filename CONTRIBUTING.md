# Contributing to TLTP

Thank you for contributing to Trải Lòng Trần Phú. Read `CONTENT_POLICY.md`, `PRIVACY.md` and `SECURITY.md` before opening an issue or pull request.

## Workflow

1. Fork the repository or create a branch from `main`.
2. Name branches `feat/...`, `fix/...`, `docs/...` or `chore/...`.
3. Use fake data in tests and screenshots only.
