...
SvelteKit server
  ...
  ├─ redacts PII and locks any detected teacher mention with [[TARGET_TEACHER]]
...
3. One request sends the role, generic target contract and content to Luna; no teacher allow-list is sent.
